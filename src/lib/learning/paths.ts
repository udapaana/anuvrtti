...
export const introductionPath: LearningPath = {
  ...
  steps: [
    ...
    },
    {
      ...
      commentary: "@deva[अण्] vowels and letters marked with @deva[उ] include their @deva[सवर्ण] (homogeneous) forms. Thus @deva[अ] includes @deva[आ]; @deva[कु] includes all five gutturals. Rule @deva[आद्गुणः] @ref[6.1.87] applies to both @deva[अ] and @deva[आ].",
    ...
    },
    {
      ...
      commentary: "In @deva[उपदेश] (technical enunciation), a nasal vowel is @deva[इत्] (indicatory). In @deva[क्विन्] or @deva[विद्], the nasal @deva[इ] is a marker, not part of the actual affix.",
    ...
    },
    {
      ...
      commentary: "A @deva[पद] (inflected word) is what ends in @deva[सुप्] (case endings) or @deva[तिङ्] (verb endings). @deva[ब्राह्मणाः] ends in @deva[जस्], a @deva[सुप्]; @deva[पचन्ति] ends in @deva[झि], a @deva[तिङ्].",
    ...
    },
    {
      sutraId: "3.1.1",
      title: "Pratyayah",
      commentary: "From here to the end of Book 5, what we treat is called @deva[प्रत्यय] (affix). This excludes @deva[प्रकृति] (base), @deva[उपपद] (dependent word), and @deva[उपधि] (conditioning element).",
...
export const tingantaLatPath: LearningPath = {
  ...
  steps: [
    ...
    },
    {
      ...
      commentary: "Within each triad: @deva[एकवचन] (singular), @deva[द्विवचन] (dual), @deva[बहुवचन] (plural).",
    ...
    },
    {
      ...
      commentary: "@deva[अट्] (acutely accented) augments the verbal stem in @deva[लुङ्], @deva[लङ्], and @deva[लृङ्]. @deva[अकरोत्], @deva[अहरत्].",
...
export const tingantaLotPath: LearningPath = {
  ...
  steps: [
    ...
    },
    {
      sutraId: "3.4.88",
      title: "Vā chandasi",
      commentary: "Optionally in Vedic (chandas), the 'hi' replacement for 'si' may or may not occur. This allows archaic imperative forms.",
      keyTerms: ["vA", "Candasi", "loT"],
    },
    {
      sutraId: "6.4.105",
      title: "Ato heḥ",
...
export const tingantaLangPath: LearningPath = {
  ...
  steps: [
    ...
    },
    {
      sutraId: "7.2.79",
      title: "Liṅah salopah",
      commentary: "In liṅ lakāra, the 's' of non-final positions is deleted. This affects the shape of liṅ endings.",
  ...
  steps: [
    {
      ...
      commentary: "The affix liṅ comes after a verb when the agent commands (vidhi), invites (nimantraṇa), permits (āmantraṇa), politely expresses a wish (adhīṣṭa), asks questions (sampraśna), or prays (prārthana). This is the optative/potential mood.",
      keyTerms: ["viDi", "liN", "nimantraRa"],
    },
    {
      sutraId: "3.4.103",
      title: "Yāsuṭ parasmaipadēṣūdāttō ṅicca",
      commentary: "When parasmaipada affixes of the Potential follow, the augment 'yāsuṭ' (acutely accented) is added. The 's' of yāsuṭ is later deleted by 7.2.79, giving forms like kuryāt, kuryātām, kuryuḥ.",
      keyTerms: ["yAsut", "parasmEpade", "Nit"],
    },
    {
      sutraId: "3.4.116",
      title: "Liṅāśiṣi",
      commentary: "When the sense is benediction (āśīḥ), the substitutes of liṅ are called ārdhadhātuka. Being ārdhadhātuka, they take the augment iṭ and don't require vikaranas like śap. E.g., lavisīṣṭa from lū (to cut).",
      keyTerms: ["liN", "ASizi", "ArDaDAtukaH"],
    },
    {
      sutraId: "3.4.104",
      title: "Kidāśiṣi",
      commentary: "The augment yāsuṭ also comes after liṅ denoting benediction, and the substitutes are treated as having indicatory 'k'. This affects guṇa/vṛddhi and semivowel changes. E.g., iṣyāt, jāgaryāt.",
      keyTerms: ["kit", "ASizi", "yAsut"],
    },
    {
      sutraId: "3.4.105",
      title: "Jhasya ran",
      commentary: "The affix 'jha' (3rd plural Ā) is replaced by 'ran' in liṅ. While jha normally becomes 'anta', in liṅ it becomes 'ran'. E.g., paceran, yajeran, kṛṣīran.",
      keyTerms: ["Ja", "ran", "liN"],
    },
    {
      sutraId: "3.4.106",
      title: "Iṭōt",
      commentary: "The short 'a' substitutes for 'i' of the ātmanepada first person singular in Potential and Benedictive. E.g., paceya, yajeya, kṛṣīya.",
      keyTerms: ["iT", "at", "Atmanepade"],
    },
    {
      sutraId: "7.2.79",
      title: "Liṅaḥ salōpōnantyasya",
      commentary: "In liṅ, the 's' of a non-final position is deleted. This applies to the 's' of yāsuṭ, converting yās to yā. Hence kuryāt from kuryas + t.",
      keyTerms: ["liNaH", "salopaH", "anantya"],
    },
    {
      sutraId: "7.1.5",
      title: "Ātmanēpadēṣvanataḥ",
      commentary: "In ātmanepada, endings not ending in 'a' get special treatment. This completes the ending transformation picture for middle voice optative.",
...
export const dhatuGanasPath: LearningPath = {
  ...
  steps: [
    ...
    {
      sutraId: "3.1.80",
      title: "Dhinvikrnvyorca",
      commentary: "The roots dhinv and kṛṇv also take the 'u' vikarana like tanādi roots.",
      keyTerms: ["u", "dhinvi", "kFRvi"],
    },
    {
      sutraId: "2.4.72",
      title: "Adiprabhrtibhyah sapah",
      commentary: "For adādi (2nd class) roots, the śap vikarana undergoes luk (deletion). The root directly takes endings: ad + ti → atti.",
      keyTerms: ["adi", "Sap", "luk"],
    },
    {
      sutraId: "2.4.75",
      title: "Juhotyādibhyah sluh",
    ...
    {
      sutraId: "3.1.81",
      title: "Kryādibhyah śnā",
      commentary: "After kryādi (9th class) roots, vikarana 'śnā' (= nā/nī) is added. krī + śnā + ti → krīṇāti.",
      keyTerms: ["SnA", "kryAdi"],
    },
    {
      sutraId: "3.1.25",
      title: "Curādibhyo ṇic",
