...
The locative (@deva[सप्तमी]) shows **where** or **when**:
...
## concept - All Seven Cases Summary

| Case | Name | Meaning | Marker |
|------|------|---------|--------|
